...
const AppAboutTextDesktop = () => {
  return (
    ...
    >
      ...
      >
        Volim duboke razgovore, one koji ne lete samo po površini, već idu pravo
        u srž, otkrivajući stvarnu suštinu stvari.
      </Typography>
      ...
      >
        Učim, istražujem, stvaram. Nekada u haosu ideja, nekada u potpunom miru,
        ali uvijek sa osjećajem da je putovanje vrijedno.
      </Typography>
...
export default AppAboutTextDesktop;
